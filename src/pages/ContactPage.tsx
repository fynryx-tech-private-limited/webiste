...
export function ContactPage() {
  useSEO({
    ...
    description: 'Have a project in mind or need IT support? Contact Fynryx today. We respond within 24 hours. Fill out our contact form or call us directly.',
    keywords: 'contact Fynryx, IT support, get in touch, contact form, business inquiries',
